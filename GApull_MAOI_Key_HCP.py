...
indications = {'nonSmallCellLung': 'nsclc',
               'melanoma': 'melanoma',
               ...
               #'esophageal': 'esophageal-cancer'} didn't start until August 20
...
def MAIOpull(indication):    
    ...
    for d in dates:
        startDate = d[0]
        endDate = d[1]
        call = 'https://www.googleapis.com/analytics/v3/data/ga?ids=ga%3A147651117&start-date='+startDate+'&end-date='+endDate+'&metrics=ga%3AnewUsers%2Cga%3ApercentNewSessions%2Cga%3Asessions%2Cga%3AbounceRate%2Cga%3AsessionDuration&dimensions=ga%3Aregion%2Cga%3Ametro%2Cga%3Acity%2Cga%3Ayear%2Cga%3Amonth%2Cga%3AchannelGrouping&ffilters=ga%3ApagePathLevel1%3D%3D%2Fhcp%2F%3Bga%3ApagePath%3D%40'+indication+'&max-results=10000&output=json&access_token='+token
        report = r.get(call)
        #print(call)
    ...
    brandframe.to_csv('/Users/josephquigley/Desktop/'+indicationList[index]+'_HCP.csv')

for p in pathList:
    MAIOpull(p)   
    print(indicationList[index] + 'HCP generated!')
    index = index+1